  ...
  return (
    <div className="page-content privacy-policy">
      ...
      <p>
        ...
        personal data Arthur M. Langer collects from you, through our
        interactions with you and through our website, and how we use that
        data.
      </p>
      ...
      <p>
        ...
        contact us, sign up for our newsletter, or otherwise interact with us.
      ...
      <p className="last-updated">Last updated: [Date to be added]</p>
    </div>
  );
};
